...
import functional.AnimalFarm;
import functional.ECommand;
import functional.YESNO;
...
public class View {
    ...
    public View() {
        ...
        this.animalFarm = new AnimalFarm();
    }
            ...
            switch (com) {
                case ADD:
                    ...
                    if (choiceInt < 1 | choiceInt > 6) {
                        ...
                        presenter.addNewAnimal(animalFarm.createNewAnimal(choiceInt, getNewAnimal()));
